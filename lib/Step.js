...
var Step = function (_React$Component) {
  ...
  Step.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        restProps = (0, _objectWithoutProperties3['default'])(_props2, ['className', 'prefixCls', 'style', 'itemWidth', 'status', 'iconPrefix', 'icon', 'wrapperStyle', 'adjustMarginRight', 'stepNumber', 'description', 'title', 'progressDot', 'tailContent', 'icons', 'classNames']);
...
Step.propTypes = {
  ...
  classNames: _propTypes2['default'].func,
